...
if("TRUE" STREQUAL "TRUE")
  set(ros_python_SOURCE_PREFIX /home/jianlan/catkin_ws/src/ros_python)
  set(ros_python_DEVEL_PREFIX /home/jianlan/catkin_ws/devel)
  ...
  set(ros_python_INSTALL_PREFIX /home/jianlan/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ros_python' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jianlan <jianlan@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ros_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jianlan/catkin_ws/src/ros_python/${idir}'.  Ask the maintainer 'jianlan <jianlan@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ros_python_dep}_FOUND)
      find_package(${ros_python_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ros_python_dep} REQUIRED ${depend_list})
  endif()
