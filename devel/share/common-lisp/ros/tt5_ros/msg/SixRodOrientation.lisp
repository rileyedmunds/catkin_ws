...
;//! \htmlinclude SixRodOrientation.msg.html

(cl:defclass <SixRodOrientation> (roslisp-msg-protocol:ros-message)
  ((rod1
    :reader rod1
    :initarg :rod1
...
(cl:defclass SixRodOrientation (<SixRodOrientation>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SixRodOrientation>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SixRodOrientation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tt5_ros-msg:<SixRodOrientation> is deprecated: use tt5_ros-msg:SixRodOrientation instead.")))

(cl:ensure-generic-function 'rod1-val :lambda-list '(m))
(cl:defmethod rod1-val ((m <SixRodOrientation>))
...
(cl:defmethod rod2-val ((m <SixRodOrientation>))
...
(cl:defmethod rod3-val ((m <SixRodOrientation>))
...
(cl:defmethod rod4-val ((m <SixRodOrientation>))
...
(cl:defmethod rod5-val ((m <SixRodOrientation>))
...
(cl:defmethod rod6-val ((m <SixRodOrientation>))
  ...
  (rod6 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SixRodOrientation>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SixRodOrientation>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SixRodOrientation>)))
  "Returns string type for a message object of type '<SixRodOrientation>"
  "tt5_ros/SixRodOrientation")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SixRodOrientation)))
  "Returns string type for a message object of type 'SixRodOrientation"
  "tt5_ros/SixRodOrientation")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SixRodOrientation>)))
  "Returns md5sum for a message object of type '<SixRodOrientation>"
  "3302cf9bd8f368d2f1c62946f4c3b333")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SixRodOrientation)))
  "Returns md5sum for a message object of type 'SixRodOrientation"
  "3302cf9bd8f368d2f1c62946f4c3b333")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SixRodOrientation>)))
  "Returns full string definition for message of type '<SixRodOrientation>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SixRodOrientation)))
  "Returns full string definition for message of type 'SixRodOrientation"
  (cl:format cl:nil "geometry_msgs/Vector3 rod1~%geometry_msgs/Vector3 rod2~%geometry_msgs/Vector3 rod3~%geometry_msgs/Vector3 rod4~%geometry_msgs/Vector3 rod5~%geometry_msgs/Vector3 rod6~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SixRodOrientation>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SixRodOrientation>))
  "Converts a ROS message object to a list"
  (cl:list 'SixRodOrientation
