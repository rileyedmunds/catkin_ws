...
class SixRodAcceleration {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SixRodAcceleration(null);
  ...
  static datatype() {
    ...
    return 'tt5_ros/SixRodAcceleration';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SixRodAcceleration(null);
...
module.exports = SixRodAcceleration;
